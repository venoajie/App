...
from strategies.managing_labels import (
    sorting_list,
    )
...
@pytest.mark.parametrize("my_trades_currency_strategy, item_reference, is_reversed, expected", [
...
def test_sorting_list (my_trades_currency_strategy,
                            item_reference,
                            is_reversed,
                            expected):
    
    result = sorting_list(my_trades_currency_strategy, 
                               item_reference,
                               is_reversed)
