...
my_trades_currency_strategy = [{'instrument_name': 'ETH-PERPETUAL', 'label': 'hedgingSpot-closed-1728806470451', 'amount': 3.0, 'price': 2466.25, 'side': 'buy'},
                               {'instrument_name': 'ETH-PERPETUAL', 'label': 'hedgingSpot-open-1728860066787', 'amount': -5.0, 'price': 2465.55, 'side': 'sell'},
                               ...
                               {'instrument_name': 'ETH-PERPETUAL', 'label': 'hedgingSpot-closed-1728806470451', 'amount': 3.0, 'price': 2466.55, 'side': 'buy'}, 
                               {'instrument_name': 'ETH-PERPETUAL', 'label': 'hedgingSpot-open-1728806470451', 'amount': -2.0, 'price': 2466.6, 'side': 'sell'}, 
...
market_condition_weak_bullish = {"strong_bearish": False,
                                "bearish": False,
                                "weak_bullish": True,
                                "weak_bearish": False,
                                "bullish": False,
...
market_condition_bullish = {"strong_bearish": False,
                                "bearish": False,
                                "weak_bullish": False,
                                "weak_bearish": False,
                                "bullish": True,
...
market_condition_bearish = {"strong_bearish": False,
                                "bearish": True,
                                "weak_bullish": False,
                                "weak_bearish": False,
                                "bullish": False,
...
@pytest.mark.parametrize("notional, sum_my_trades_currency_strategy, over_hedged_closing, market_condition, expected", [
...
def test_size_to_be_hedged (notional, 
                            sum_my_trades_currency_strategy,
                            over_hedged_closing,
                            market_condition,
                            expected):
    
    result = size_to_be_hedged(notional,
                               sum_my_trades_currency_strategy,
                                over_hedged_closing,
                                market_condition)
