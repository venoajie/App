...
def test_net_size_not_over_bought(my_trades_currency_strategy, transaction, expected):
...
def test_get_waiting_time_factor(strong_fluctuation, some_fluctuation, expected):
